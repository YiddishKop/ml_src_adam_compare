...
def main():
	...
	d_optim = tf.train.AdamOptimizer(lr*0.2, beta1 = beta1).minimize(loss['d_loss'], var_list=variables['d_vars'])
		...
		for i in range(epochs):
			...
			#while batch_no* < loaded_data['data_length']:
				...
				if batch_no == 100:
					...
					save_for_vis(real_images, gen, i)
...
def save_for_vis(real_images, generated_images, epoch):
	...
	for i in range(0, real_images.shape[0]):
		...
		scipy.misc.imsave(join("./sample_image", 'samples/fake_image_ep{}_{}.jpg'.format(epoch, i)), fake_images_255)
